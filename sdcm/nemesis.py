...
class Nemesis:
    ...
    def execute_nemesis(self, nemesis_class):
        ...
        try:
            disrupt_method_wrapper(nemesis_class.disrupt)()
        finally:
    ...
    def build_disruptions_by_selector(self, nemesis_selector: str | None = None):
        ...
        for subclass in subclasses:
            try:
                disruptions.append(subclass(self))
...
class CategoricalMonkey(Nemesis):
    ...
    def get_disruption_distribution(self, dist: dict, default_weight: float) -> Tuple[List[Callable], List[float]]:
        ...
        all_methods = {method.__class__.__name__: method for method in self.build_disruptions_by_selector(
            self.nemesis_selector)}
...
class ScyllaCloudLimitedChaosMonkey(Nemesis):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.disruptions_list = self.build_disruptions_by_name([
            ...
            'StopStartMonkey', 'disrupt_major_compaction',
